...
public class GroupByDateState {
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // Regrouper selon Order Date et State
            String keyText = fields[2] + "_" + fields[10]; // Order Date et State
    ...
    public static class Reduce extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
        ...
        public void reduce(Text key, Iterable<DoubleWritable> values, Context context)
            ...
            context.write(key, new DoubleWritable(sum));  // Écrire le profit total par Order Date et State dans le résultat de la sortie du job
